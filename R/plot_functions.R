...
#' \code{\link{mk_brc}}) is ploted on a single frame by index.  This can be
...
#' @inheritParams iec_score
#' @seealso \code{\link{mk_brc}}
#' @examples
#' plot_lob(brc, 20)
...
#' \code{\link{mk_brc}} along with the observations used to generate them.
#'
...
#' order.  Generally, \code{sp} and \code{gradient} will be the same variables
#' used to generate \code{brc} with \code{\link{mk_brc}}.  Because many plots
...
#' @seealso \code{\link{mk_brc}}, \code{\link{scale10}}, \code{\link[grDevices]{Devices}}
#' @examples
#' plot_brc(sp, brc, grad)
