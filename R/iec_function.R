...
#' values will take longer to process.  The default value is 30.
#'
#' @param brc BRC data frame generated by \code{\link{est_brc}}
#' @param method one of \code{"pa"} (default; CalcPA) or \code{"q"} (CalcQ).
#' @param n_reps single integer value setting the number of random starts used
#'   in optimization (default is 30).
